...
#define MAX_COUNT_WAIT_SEND_PROTOCOL (unsigned long)/*0XFFFFF*/4000U
#define MAX_COUNT_WAIT (unsigned long)/*0XFFFFF*/ 2000U
#define MAX_COUNT_WAIT_SESSION (unsigned long)/*0XFFFF*/ 2000U
#define MAX_COUNT_WAIT_BEACON (unsigned long)/*15000U*/ 2000U
