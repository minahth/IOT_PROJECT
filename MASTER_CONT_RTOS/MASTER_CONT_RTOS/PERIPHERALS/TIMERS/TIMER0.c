...
#include "TIMER0.h"
 ...
 dont change TCNT0_ACCESS or clock_carry */
  void TIMER0_ENABLE(T0_clock fre,timer0_mode mode,TIMER0_COMPARE_OUTPUT_MOD cmpmode,TIMER0_INT intmode)
  {  
	  TCCR0_ACCESS=0x00;
	  TIMSK_ACCESS&=0xfC;
...
{
	TIMER0_ENABLE(TIMER_T0_SOURCE_RISING,CTC_MOD,NON_INVERT_OC0_TOGGLE,INT_DISABLE);
...
void TIMER0_SET_COUNTER(unsigned char X)
{
	TCNT0=X;
}
unsigned char TIMER0_READ_OCR0()
{
	return OCR0;
}
void TIMER0_SET_OCR0(unsigned char X)
{
	OCR0=X;
}	